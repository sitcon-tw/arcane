...
class card(models.Model):
    ...
    name = models.CharField(verbose_name="Name", help_text="Name of the card.")
    long_desc = models.TextField(verbose_name="Descriptions", help_text="Long descriptions about the card.")
    history = HistoricalRecords()
